...
class TranslateLocalController extends Controller
{
    ...
    use Index,
        ...
        Update,
        Destroy,
        TranslateLocal\Filters,
        TranslateLocal\RequestData,
        TranslateLocal\QueryFilterType,
        TranslateLocal\RequestFilter;
}
